...
TEST(NaturalAdd, 1byADD)
{
	BigNatural one = BigNatural("");
	BigNatural two = BigNatural(1);

	EXPECT_TRUE(naturalMatch(BigNatural(""), ADD_NN_N(one, two)));


	EXPECT_TRUE(naturalMatch(BigNatural(""), one));
}

TEST(NaturalAdd, 1byMethod)
{
	BigNatural one = BigNatural("");


	EXPECT_TRUE(naturalMatch(BigNatural(""), ADD_1N_N(one)));

	EXPECT_TRUE(naturalMatch(BigNatural(""), one));
}
...
TEST(NaturalMod, simple1)
{
	...
	EXPECT_TRUE(naturalMatch(BigNatural(), MOD_NN_N(one, two)));


	EXPECT_TRUE(naturalMatch(BigNatural(55), one));
	EXPECT_TRUE(naturalMatch(BigNatural(11), two));
}
...
TEST(NaturalMod, simple2)
{
	...
	EXPECT_TRUE(naturalMatch(BigNatural(5), one));
	EXPECT_TRUE(naturalMatch(BigNatural(6), two));
}
...
TEST(NaturalMod, simple4)
{
	BigNatural one = BigNatural(13);
	BigNatural two = BigNatural(5);

	EXPECT_TRUE(naturalMatch(BigNatural(3), MOD_NN_N(one, two)));


	EXPECT_TRUE(naturalMatch(BigNatural(13), one));
	EXPECT_TRUE(naturalMatch(BigNatural(5), two));
}

TEST(NaturalMod, longNum)
{
	BigNatural one = BigNatural("16598439546315445954516545663145631254615462954269246292495562192462462459262154962455621246152261249");
	BigNatural two = BigNatural("156948326152349643526134926324614395163426195342613246145342463426134296432623");

	EXPECT_TRUE(naturalMatch(BigNatural("115106086797054241427425476630772216436444860109045916545682925004314319830910"), MOD_NN_N(one, two)));
}

TEST(NaturalMod, longNumShortMod)
{
	BigNatural one = BigNatural("16598439546315445954516545663145631254615462954269246292495562192462462459262154962455621246152261249");
	BigNatural two = BigNatural("1569483");

	EXPECT_TRUE(naturalMatch(BigNatural("500845"), MOD_NN_N(one, two)));
}
